...
public class RouteLogServiceImpl implements RouteLogService {
	...
	public RouteLogServiceImpl(ShortUrlRepository shortUrlRepository, RouteLogRepository routeLogRepository) {
	...
	public void logging(String path, String referer, String userAgent, String remoteAddress) {
		ShortUrl shortUrl = shortUrlRepository.findByPathAndIsActiveNot(path, false);
